...
def Dijkstra(grafo,vertice_origem):
    ...
    if vertice_origem < 0 or vertice_origem >= grafo.qtdVertices():
        ...
        distancias = {vertice: inf for vertice in range(grafo.qtdVertices())}
        caminhos = {vertice: -1 for vertice in range(grafo.qtdVertices())}
        ...
        for proximo, origem in caminhos.items():
            ...
            caminho = [str(string+1) for string in caminho]
